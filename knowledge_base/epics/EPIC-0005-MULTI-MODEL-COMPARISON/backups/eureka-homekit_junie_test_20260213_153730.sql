...
\restrict pi2DB2ZqMy8EJhkyMw5lAGcd3YlRlIYETKj0DbC3IRQH0dAFf1Fn9GKEAnJsvJk
...
environment	test	2026-02-13 21:20:17.579955	2026-02-13 21:20:17.579957
schema_sha1	66fe7e424b26305fbedd9a8f917885ddcc067fa9	2026-02-13 21:20:17.580732	2026-02-13 21:20:17.580733
\.
...
COPY public.control_events (id, accessory_id, action_type, characteristic_name, created_at, error_message, latency_ms, new_value, old_value, scene_id, success, updated_at, user_ip) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.accessories_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.control_events_id_seq', 28, true);
...
SELECT pg_catalog.setval('public.homekit_events_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.homes_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.scenes_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.sensor_value_definitions_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.sensors_id_seq', 18, true);
...
\unrestrict pi2DB2ZqMy8EJhkyMw5lAGcd3YlRlIYETKj0DbC3IRQH0dAFf1Fn9GKEAnJsvJk
