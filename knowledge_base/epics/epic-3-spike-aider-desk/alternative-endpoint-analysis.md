# Alternative Endpoint Analysis: Supporting Agent Mode
...
## 1. Objective
Analyze AiderDesk's available API endpoints to improve the visibility of Agent Mode's internal processes (planning, tool execution) and reduce friction during implementation tasks.
